...
namespace Unity.FPS.UI
{
    public class FeedbackFlashHUD : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            FPSPlayerController playerCharacterController = FindObjectOfType<FPSPlayerController>();
            DebugUtility.HandleErrorIfNullFindObject<FPSPlayerController, FeedbackFlashHUD>(
