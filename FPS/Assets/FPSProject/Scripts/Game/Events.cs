...
namespace Unity.FPS.Game
{
    ...
    public static class Events
    {
        ...
        public static PickupGrenadeEvent PickupGrenadeEvent = new PickupGrenadeEvent();
        public static PickupWeaponEvent PickupWeaponEvent = new PickupWeaponEvent();
    ...
    public class PickupGrenadeEvent : GameEvent
    {
        public GameObject PickupGrenade;
    }

    public class PickupWeaponEvent : GameEvent
    {
